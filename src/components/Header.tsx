  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur bg-black/30">
      <div className="container flex items-center justify-between py-4">
        <div className="text-[18px] md:text-[20px] tracking-tight3 font-display">WISE ROOTREE</div>
        ...
        <nav className={clsx('hidden md:flex gap-8 text-[14px] tracking-tight2 text-white/80')}>
      ...
      {open && (
        <div className="md:hidden container pb-4">
          <div className="ink-card p-4 flex flex-col gap-3 text-white/80 text-sm">
